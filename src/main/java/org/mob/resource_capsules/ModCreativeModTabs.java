...
public class ModCreativeModTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CAPSULE_TAB = CREATIVE_MODE_TABS.register("capsule_tab",
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CATALYST_TAB = CREATIVE_MODE_TABS.register("catalyst_tab",
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MISC_TAB = CREATIVE_MODE_TABS.register("misc_tab",
