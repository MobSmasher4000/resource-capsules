...
public class ResourceGenTierScreen extends AbstractContainerScreen<ResourceGenTierMenu> {
    ...
    public ResourceGenTierScreen(ResourceGenTierMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
