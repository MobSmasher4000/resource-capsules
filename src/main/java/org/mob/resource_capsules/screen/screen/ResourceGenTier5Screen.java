...
public class ResourceGenTier5Screen extends AbstractContainerScreen<ResourceGenTier5Menu> {
    ...
    public ResourceGenTier5Screen(ResourceGenTier5Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
