...
public class ResourceGenTier1Screen extends AbstractContainerScreen<ResourceGenTier1Menu> {
    ...
    public ResourceGenTier1Screen(ResourceGenTier1Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
