...
public class FluidGenScreen extends AbstractContainerScreen<FluidGenMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ResourceCapsules.MOD_ID, "textures/gui/fluid_gen/fluid_gen_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            new ResourceLocation(ResourceCapsules.MOD_ID, "textures/gui/arrow_progress_fluid.png");
