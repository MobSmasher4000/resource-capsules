...
public class ResourceGenTier3Screen extends AbstractContainerScreen<ResourceGenTier3Menu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ResourceCapsules.MOD_ID, "textures/gui/resource_gen_tier/resource_gen_tier_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ResourceCapsules.MOD_ID, "textures/gui/arrow_progress.png");

    public ResourceGenTier3Screen(ResourceGenTier3Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
