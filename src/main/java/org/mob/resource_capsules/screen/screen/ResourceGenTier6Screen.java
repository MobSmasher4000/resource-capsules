...
public class ResourceGenTier6Screen extends AbstractContainerScreen<ResourceGenTier6Menu> {
    ...
    public ResourceGenTier6Screen(ResourceGenTier6Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
