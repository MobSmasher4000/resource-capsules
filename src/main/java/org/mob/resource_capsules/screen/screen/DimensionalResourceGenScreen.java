...
public class DimensionalResourceGenScreen extends AbstractContainerScreen<DimensionalResourceGenMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ResourceCapsules.MOD_ID, "textures/gui/jei/resource_gen_tier_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ResourceCapsules.MOD_ID, "textures/gui/arrow_progress.png");

    public DimensionalResourceGenScreen(DimensionalResourceGenMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
