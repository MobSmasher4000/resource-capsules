...
public class ResourceGenTier1Menu extends AbstractContainerMenu {
    public final ResourceGenTier1BlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ResourceGenTier1Menu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ResourceGenTier1Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.RESOURCE_GEN_TIER_1_MENU.get(), pContainerId);
