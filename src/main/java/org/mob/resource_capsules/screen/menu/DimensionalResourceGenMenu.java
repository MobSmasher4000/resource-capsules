...
public class DimensionalResourceGenMenu extends AbstractContainerMenu {
    public final DimensionalResourceGenBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public DimensionalResourceGenMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public DimensionalResourceGenMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DIMENSIONAL_RESOURCE_GEN_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((DimensionalResourceGenBlockEntity) entity);
        ...
        this.addSlot(new SingleSlot(blockEntity.inputHandler, 0, 54, 34));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.DIMENSIONAL_RESOURCE_GEN.get());
    }
