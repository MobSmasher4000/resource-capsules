...
public class ResourceGenTier3Menu extends AbstractContainerMenu {
    public final ResourceGenTier3BlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ResourceGenTier3Menu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ResourceGenTier3Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.RESOURCE_GEN_TIER_3_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((ResourceGenTier3BlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.RESOURCE_GEN_TIER_3.get());
    }
