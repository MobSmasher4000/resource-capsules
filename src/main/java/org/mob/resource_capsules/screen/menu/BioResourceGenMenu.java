...
public class BioResourceGenMenu extends AbstractContainerMenu {
    ...
    public BioResourceGenMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public BioResourceGenMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SingleSlot(iItemHandler, 0, 12, 15));
            this.addSlot(new SingleSlot(iItemHandler, 1, 86, 15));
            this.addSlot(new OutputSlot(iItemHandler, 2, 86, 60));
        });
