...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    // 1. Fixed the syntax typo on the constructor (removed the stray '>')
...
//        Bio Capsule Recipes
        ...
        // Bio Capsule
        // 2. Updated the manual fluid registry string grab to just natively use Fluids.WATER,
        // matching what you did perfectly in the fluid_gen mud recipe further down.
        BioResourceGenRecipeBuilder.bioResourceGenRecipe()
                .addIngredient(Ingredient.of(ModItems.BIO_CATALYST.get()))
                .addFluidInput(new FluidStack(Fluids.WATER, 1000))
        ...
        registerTieredRecipe(consumer, "copper", capsules_tier1,
                new Item[]{ATORegistry.COPPER_NUGGET.get(), Items.COPPER_INGOT, Items.COPPER_BLOCK},
                new int[]{3, 1, 1}, new String[]{"CCC","   ","   "});

        // Tin
        registerTieredRecipe(consumer, "tin", capsules_tier1,
                new Item[]{ATORegistry.TIN.NUGGET.get(), ATORegistry.TIN.INGOT.get(), ATORegistry.TIN.BLOCK.get().asItem()},
        ...
        registerTieredRecipe(consumer, "silver", capsules_tier2,
                new Item[]{ATORegistry.SILVER.NUGGET.get(), ATORegistry.SILVER.INGOT.get(), ATORegistry.SILVER.BLOCK.get().asItem()},
                new int[]{3, 1, 1}, new String[]{"C  ", "C  ", "C  "});

        // Nickel
        registerTieredRecipe(consumer, "nickel", capsules_tier2,
                new Item[]{ATORegistry.NICKEL.NUGGET.get(), ATORegistry.NICKEL.INGOT.get(), ATORegistry.NICKEL.BLOCK.get().asItem()},
        ...
        registerTieredRecipe(consumer, "lead", capsules_tier2,
                new Item[]{ATORegistry.LEAD.NUGGET.get(), ATORegistry.LEAD.INGOT.get(), ATORegistry.LEAD.BLOCK.get().asItem()},
                new int[]{3, 1, 1}, new String[]{"C C", " C ", "   "});
        ...
        registerTieredRecipe(consumer, "osmium", capsules_tier3,
                new Item[]{ATORegistry.OSMIUM.NUGGET.get(), ATORegistry.OSMIUM.INGOT.get(), ATORegistry.OSMIUM.BLOCK.get().asItem()},
                new int[]{3, 1, 1}, new String[]{"CCC", "   ", "   "});

        // Uranium
        registerTieredRecipe(consumer, "uranium", capsules_tier3,
                new Item[]{ATORegistry.URANIUM.NUGGET.get(), ATORegistry.URANIUM.INGOT.get(), ATORegistry.URANIUM.BLOCK.get().asItem()},
                new int[]{3, 1, 1}, new String[]{"CC ", "  C", "   "});
        ...
        registerTieredRecipe(consumer, "platinum", capsules_tier3,
                new Item[]{ATORegistry.PLATINUM.NUGGET.get(), ATORegistry.PLATINUM.INGOT.get(), ATORegistry.PLATINUM.BLOCK.get().asItem()},
                new int[]{3, 1, 1}, new String[]{"C  ", "C  ", "C  "});

        // Aluminum
        registerTieredRecipe(consumer, "aluminum", capsules_tier3,
                new Item[]{ATORegistry.ALUMINUM.NUGGET.get(), ATORegistry.ALUMINUM.INGOT.get(), ATORegistry.ALUMINUM.BLOCK.get().asItem()},
                new int[]{3, 1, 1}, new String[]{"C C", " C ", "   "});
    ...
    // 3. Changed Consumer<FinishedRecipe> parameter requirement to RecipeOutput in all custom helper functions below
    private void registerOverworldRecipes(RecipeOutput consumer) {
    ...
    private void registerNetherRecipes(RecipeOutput consumer) {
    ...
    private void registerEndRecipes(RecipeOutput consumer) {
    ...
    private void registerTieredRecipe(RecipeOutput consumer, String group, Item[] capsules, Item[] outputs, int[] outputCounts, String[] strings) {
        for (int i = 0; i < 3; i++) {
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.MISC, outputs[i], outputCounts[i])
                    .pattern(strings[0])
                    .pattern(strings[1])
                    .pattern(strings[2])
                    .group(group)
    ...
    private void resourceGenTier1Recipe(RecipeOutput consumer, Item input, Item output) {
    ...
    private void resourceGenTier2Recipe(RecipeOutput consumer, Item input, Item output) {
    ...
    private void resourceGenTier3Recipe(RecipeOutput consumer, Item input, Item output) {
    ...
    private void dimensionalResourceGenRecipe(RecipeOutput consumer, Item input, Item output, String dimension) {
