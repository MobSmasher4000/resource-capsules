...
public class ResourceGenTier2RecipeBuilder implements RecipeBuilder {
    ...
    @Override
    public ResourceGenTier2RecipeBuilder unlockedBy(String name, Criterion<?> criterion) {
    ...
    public void save(RecipeOutput pRecipeOutput, ResourceLocation pId) {
        ...
        ResourceLocation recipeId = ResourceLocation.fromNamespaceAndPath(
                pId.getNamespace(),
                "resource_gen_tier_2/" + pId.getPath()
        );

        ResourceLocation advancementId = ResourceLocation.fromNamespaceAndPath(
                pId.getNamespace(),
                "recipes/resource_gen_tier_2/" + pId.getPath()
        );

        ResourceGenTier2Recipe recipe = new ResourceGenTier2Recipe(List.of(this.ingredient), this.output);
