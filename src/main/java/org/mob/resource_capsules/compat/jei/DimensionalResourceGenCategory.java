...
public class DimensionalResourceGenCategory implements IRecipeCategory<DimensionalResourceGenRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(ResourceCapsules.MOD_ID, "dimensional_resource_gen");
    ...
    public DimensionalResourceGenCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 174, 80);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.DIMENSIONAL_RESOURCE_GEN.get()));
    }

    @Override
    public RecipeType<DimensionalResourceGenRecipe> getRecipeType() {
        return DIMENSIONAL_RESOURCE_GEN_RECIPE_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, DimensionalResourceGenRecipe recipe, IFocusGroup focuses) {
