...
public class ResourceGenTier3Category implements IRecipeCategory<ResourceGenTier3Recipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(ResourceCapsules.MOD_ID, "resource_gen_tier_3");
    ...
    public static final RecipeType<ResourceGenTier3Recipe> RESOURCE_GEN_TIER_3_RECIPE_TYPE =
            new RecipeType<>(UID, ResourceGenTier3Recipe.class);

    private final IDrawable background;
    private final IDrawable icon;

    public ResourceGenTier3Category(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 174, 80);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.RESOURCE_GEN_TIER_3.get()));
    }

    @Override
    public RecipeType<ResourceGenTier3Recipe> getRecipeType() {
        return RESOURCE_GEN_TIER_3_RECIPE_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, ResourceGenTier3Recipe recipe, IFocusGroup focuses) {
