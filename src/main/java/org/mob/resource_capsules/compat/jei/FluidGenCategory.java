...
public class FluidGenCategory implements IRecipeCategory<FluidGenRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(ResourceCapsules.MOD_ID, "fluid_gen");
    public static final ResourceLocation TEXTURE = new ResourceLocation(ResourceCapsules.MOD_ID, "textures/gui/jei/fluid_gen_gui.png");
