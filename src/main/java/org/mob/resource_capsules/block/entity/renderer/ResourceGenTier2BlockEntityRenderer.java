...
public class ResourceGenTier2BlockEntityRenderer implements BlockEntityRenderer<ResourceGenTier2BlockEntity> {
    ...
    @Override
    public void render(ResourceGenTier2BlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        if (pBlockEntity.getLevel() != null) {
            Direction facing = pBlockEntity.getBlockState().getValue(ResourceGenTier2Block.FACING);
