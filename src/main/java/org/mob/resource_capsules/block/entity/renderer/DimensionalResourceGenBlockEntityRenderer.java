...
public class DimensionalResourceGenBlockEntityRenderer implements BlockEntityRenderer<DimensionalResourceGenBlockEntity> {
    ...
    @Override
    public void render(DimensionalResourceGenBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        if (pBlockEntity.getLevel() != null) {
            Direction facing = pBlockEntity.getBlockState().getValue(DimensionalResourceGenBlock.FACING);
